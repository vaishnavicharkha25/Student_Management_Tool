    ...
    <div className='sticky-top'>
      <nav className="sticky-top navbar navbar-expand-lg bg-purple">
        <div className='nav-brand'>
          <h3 className='text-white pt-1 px-4'>Student Management</h3>
        </div>
        <div className="collapse navbar-collapse justify-content-end">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link px-4" to="/add-student">
                <button className='btn btn-add' type="submit">Add Student</button>
              </Link>
            </li>
          </ul>
        </div>
